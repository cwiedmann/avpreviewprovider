...
class lib
{
	...
	public static function hash_data($file, $offset, $end, $algorithm) {
		...
		while (true) {
			if (AVPREVIEWPROVIDERGETID3_OS_ISWINDOWS) {
				...
				$commandline  = AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'head.exe -c '.$end.' '.escapeshellarg(str_replace('/', DIRECTORY_SEPARATOR, $file)).' | ';
				$commandline .= AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'tail.exe -c '.$size.' | ';
				$commandline .= AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.$windows_call;
	...
	public static function IncludeDependency($filename, $sourcefile, $DieOnFailure=false) {
		global $AVPREVIEWPROVIDERGETID3_ERRORARRAY;
		...
		if ($DieOnFailure) {
			...
			$AVPREVIEWPROVIDERGETID3_ERRORARRAY[] = $diemessage;
		}
		return false;
	}
