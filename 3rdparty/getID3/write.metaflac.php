...
class metaflac
{
	...
	public function WriteMetaFLAC() {
		...
		$tempcommentsfilename = tempnam(AVPREVIEWPROVIDERGETID3_TEMP_DIR, 'getID3');
		...
		if (AVPREVIEWPROVIDERGETID3_OS_ISWINDOWS) {
			...
			if (file_exists(AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'metaflac.exe')) {
				//$commandline = '"'.AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'metaflac.exe" --no-utf8-convert --remove-all-tags --import-tags-from="'.$tempcommentsfilename.'" "'.str_replace('/', '\\', $this->filename).'"';
				...
				$commandline = AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'metaflac.exe --no-utf8-convert --remove-all-tags --import-tags-from='.escapeshellarg($tempcommentsfilename).' '.escapeshellarg($this->filename).' 2>&1';
				...
				$metaflacError = 'metaflac.exe not found in '.AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR;
			}
	...
	public function DeleteMetaFLAC() {
		...
		if (AVPREVIEWPROVIDERGETID3_OS_ISWINDOWS) {
			...
			if (file_exists(AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'metaflac.exe')) {
				...
				$commandline = AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'metaflac.exe --remove-all-tags "'.$this->filename.'" 2>&1';
				$metaflacError = `$commandline`;
