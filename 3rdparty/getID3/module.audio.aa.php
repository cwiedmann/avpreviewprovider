...
class aa extends handler
{
	...
	public function Analyze() {
		...
		if (substr($AAheader, 4, 4) != $magic) {
			$this->error('Expecting "'.lib::PrintHexBytes($magic).'" at offset '.$info['avdataoffset'].', found "'.lib::PrintHexBytes(substr($AAheader, 4, 4)).'"');
			return false;
		}
...
return false;
		...
		$thisfile_aa['filesize'] = lib::BigEndian2Int(substr($AUheader,  0, 4));
