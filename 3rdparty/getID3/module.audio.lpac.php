...
class lpac extends handler
{
	...
	public function Analyze() {
		...
		$info['lpac']['file_version'] = lib::BigEndian2Int(substr($LPACheader,  4, 1));
		$flags['audio_type']                  = lib::BigEndian2Int(substr($LPACheader,  5, 1));
		$info['lpac']['total_samples']= lib::BigEndian2Int(substr($LPACheader,  6, 4));
		$flags['parameters']                  = lib::BigEndian2Int(substr($LPACheader, 10, 4));
