	...
	public function WriteVorbisComment() {
		...
		if (AVPREVIEWPROVIDERGETID3_OS_ISWINDOWS) {
			...
			if (file_exists(AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'vorbiscomment.exe')) {
				//$commandline = '"'.AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'vorbiscomment.exe" -w --raw -c "'.$tempcommentsfilename.'" "'.str_replace('/', '\\', $this->filename).'"';
				...
				$commandline = AVPREVIEWPROVIDERGETID3_HELPERAPPSDIR.'vorbiscomment.exe -w --raw -c "'.$tempcommentsfilename.'" "'.$this->filename.'" 2>&1';
